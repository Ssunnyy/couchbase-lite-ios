...
- (void) testPushDoc {
    ...
    CBLDocument* result = [otherDB documentWithID:@"doc1"];
    AssertEqualObjects([result stringForKey:@"name"], @"Tiger");
}
...
- (void) testPullDoc {
    ...
    CBLDocument* result = [otherDB documentWithID:@"doc2"];
    AssertEqualObjects([result stringForKey:@"name"], @"Cat");
}
...
- (void) testPullConflict {
    ...
    AssertEqual(self.db.count, 1u);
    CBLDocument* result = [self.db documentWithID:@"doc"];
    AssertEqualObjects(result.toDictionary, (@{@"species": @"Tiger",
                                             @"name": @"Hobbes",
                                             @"pattern": @"striped"}));
}
